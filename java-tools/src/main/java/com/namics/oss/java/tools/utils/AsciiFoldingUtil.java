...
/**
 * AsciiFoldingUtil is a helper class to do ASCII folding.
 *
 * @author aschaefer, namics ag
 * @since 2.0
 */
public abstract class AsciiFoldingUtil {
	/**
	 * Converts characters above ASCII to their ASCII equivalents. For example, accents are removed from accented
	 * characters.
	 *
	 * @param query The string to fold.
	 * @return the folded string.
	 */
	static public String asciiFold(String query) {
